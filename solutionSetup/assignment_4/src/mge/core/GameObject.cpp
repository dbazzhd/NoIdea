...
void GameObject::setObjectType(int pType) {
	_objectType = pType;
}
int GameObject::getObjectType() {
	return _objectType;
}
void GameObject::setCollisionFunction(std::string pCollisionFunction, int pTypeB) {
	_collisionFunction[pTypeB] = pCollisionFunction;
}
std::string GameObject::getCollisionFunction(int pTypeB) {
	//cout << pTypeA << " :A, " << pTypeB << " :B , " << _collisionFunction[pTypeB] << std::endl;
	return _collisionFunction[pTypeB];
}
void GameObject::DebugPosition() {
	std::cout << getWorldPosition().x << "  " <<  getWorldPosition().y << "  " << getWorldPosition().z << std::endl;
}
