...
class GameObject
{
	public:
		...
		void setObjectType(int pType);
		int getObjectType();
		void setCollisionFunction(std::string pCollisionFunction, int pTypeB);
		std::string getCollisionFunction(int pTypeB);
    ...
    private:
		...
		int _objectType;
		std::map<int,std::string> _collisionFunction;
